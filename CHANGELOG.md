...
- Pull requests and manual dispatches now build the app and run the complete unit and service suite on the stable macOS 26, Xcode 26.6, and iOS 26.5 Simulator toolchain without signing.
